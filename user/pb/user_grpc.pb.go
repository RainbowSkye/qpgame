...
type UserServiceClient interface {
	...
	FindUserByUid(ctx context.Context, in *UserParams, opts ...grpc.CallOption) (*UserDTO, error)
}
...
func (c *userServiceClient) FindUserByUid(ctx context.Context, in *UserParams, opts ...grpc.CallOption) (*UserDTO, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserDTO)
	err := c.cc.Invoke(ctx, UserService_FindUserByUid_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	FindUserByUid(context.Context, *UserParams) (*UserDTO, error)
...
func _UserService_FindUserByUid_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_FindUserByUid_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).FindUserByUid(ctx, req.(*UserParams))
	}
	return interceptor(ctx, in, info, handler)
}
